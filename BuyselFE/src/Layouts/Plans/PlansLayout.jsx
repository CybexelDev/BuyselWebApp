...
const PricingTable = () => {
  ...
  return (
    <div className="bg-[#F8FFF7] py-10 px-4 lg:px-12 xl:px-16">
...
max-w-6xl mx-auto items-start">
        ...
        {plans.map((plan) => (
          <div
            key={plan.name}
            className="bg-[#F1FDDA] h-[110px] lg:h-[120px] w-[183px] 
      rounded-3xl flex flex-col justify-center items-center ml-22"
          >
  ...
  w-[240px] lg:w-[240px] xl:w-[320px]">
      ...
      rounded-3xl p-4 lg:p-6 border-t border-[#F1FDDA]">
