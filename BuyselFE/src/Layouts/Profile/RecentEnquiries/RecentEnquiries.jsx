            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-[#f6f6f6] rounded-[18px] p-5 shadow-md h-fit h-full">
                    ...
                    <div className="space-y-3">
                        ...
                        <button onClick={()=>handleNavigate("/contact")} className="text-left flex gap-2 bg-[#FFFFFF] rounded-[9px] host-grotesk shadow-md hover:bg-[#e9e9e9] px-5 py-2 rounded-lg text-[16px] text-[#7B7B7B] cursor-pointer">
                            <img src={i2} className=" w-[19px] h-[19px] mt-[3px]" /> Contact Support
                        </button>
                        <button onClick={()=>handleNavigate("/helpcenter")} className="text-left flex gap-2 bg-[#FFFFFF] rounded-[9px] host-grotesk shadow-md hover:bg-[#e9e9e9] px-5 py-2 rounded-lg text-[16px] text-[#7B7B7B] cursor-pointer">
