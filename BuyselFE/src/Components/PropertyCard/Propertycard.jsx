...
<div className="bg-white rounded-2xl overflow-hidden w-full sm:w-[305px] h-[375px]">
      ...
      <div className="relative flex justify-center pt-2">
        ...
        <div className="absolute top-4 right-6 flex gap-1 ">
         <button className="bg-white  rounded-full h-[23px] w-[23px] flex justify-center items-center ">
            <Heart size={13} />
          </button>
 ...
 <img src={icon} alt="icon" className="h-[12px] w-[12px]" />
        ...
        <p className="instrument-sans flex items-center text-[12px] gap-1 mb-2 text-black font-[400] ">
          <img src={map} alt="map"/>  {property.location}
        </p>

        
       <div className=" text-black space-y-1">
  <h2 className="instrument-sans font-[600] text-[15px] leading-[100%]">₹ DM for details</h2>
  ...
  <span className="flex items-center ">
    <img src={measure} alt="" className="w-[13px] h-[13px]" />{property.area}
  </span>
  <span className="flex items-center gap-0.5">
    <img src={apartment} alt="" className="w-[13px] h-[13px]"  />Listed by{property.owner} 
  </span>
</div>
      ...
      >
        ...
        <span className="instrument-sans font-[700] text-[13px]">WhatsApp</span>
      </a>
