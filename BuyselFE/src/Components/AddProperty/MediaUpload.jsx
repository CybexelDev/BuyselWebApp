 ...
 const updateFiles = (key, files) => {
  ...
  return (
    <div className="bg-white   rounded-2xl w-full">
      ...
      <div className="mb-6">
        <p className="lexend text-[16px] font-[600] leading-[135%] mb-2">Property Image</p>
