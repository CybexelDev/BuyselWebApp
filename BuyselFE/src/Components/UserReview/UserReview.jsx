        ...
        <div className="flex gap-1">
          {[...Array(5)].map((_, i) => (
            <span
              key={i}
              className={`text-[18px] ${
                i < review.rating ? "text-[#84cc16]" : "text-[#d1d1d1]"
              }`}
            >
              <FaStar />
  ...
  <div className="leading-tight">
    ...
    <p className="text-[13px] text-[#9B9B9B]">
      21/12/2025
        ...
        {/* User Info */}
        {/* <div >
          <h4 className="host-grotesk font-[600]
                         text-[16px] leading-[135%]">
            {review.name}
          </h4>
          <p className="text-[14px] text-[#8C8F88]">
            {review.city}
          </p>
        </div> */}
